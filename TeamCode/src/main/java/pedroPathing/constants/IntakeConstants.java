...
public class IntakeConstants {
    ...
    /** Maximum reach distance for automatic intake (inches) - alias for AUTO_INTAKE_MAX_SLIDE_REACH */
    public static double AUTO_INTAKE_MAX_REACH = AUTO_INTAKE_MAX_SLIDE_REACH;

    /** Maximum angle for automatic intake (degrees) - alias for AUTO_INTAKE_TURRET_MAX_ANGLE */
    public static double AUTO_INTAKE_MAX_ANGLE = AUTO_INTAKE_TURRET_MAX_ANGLE;
...
//    public static double SLIDE_MAX_EXTENSION = 0.26;
    ...
    public static int INTAKE_CLAW_RELEASE = 400;
