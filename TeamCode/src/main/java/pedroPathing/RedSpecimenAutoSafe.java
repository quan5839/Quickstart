...
@Autonomous(name = "Red Specimen Auto Safe", group = "Autonomous", preselectTeleOp = "Red Specimen Teleop")
public class RedSpecimenAutoSafe extends OpMode {
    ...
    public void autonomousPathUpdate() {
        ...
        case 1:
            ...
            break;
        case 2:
            if(stateMachine.getCurrentState() == RobotState.SPECIMEN_OUTTAKE_SCORE) {
                ...
                follower.followPath(pushPickup1Prep, false);
                setPathState(3);
            }
