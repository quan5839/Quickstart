...
# Constants for yellow detection - based on FTC-12527-FatDragon implementation
...
def runPipeline(frame, llrobot):
    """
    Main pipeline function for yellow sample detection
    ...
    try:
        ...
        # Process yellow color using FatDragon method
        ...
        for i, contour in enumerate(yellow_contours):
            ...
            for sep_contour in separate_touching_contours(contour):
                ...
                if area > largest_area:
                    ...
                    llpython = [1, center[0], center[1], angle, 2, quadrant, 100, area]
        ...
        for contour_info in valid_contours:
            ...
            # Draw center point
            cv2.circle(frame, contour_info['center'], 5, (0, 255, 0), -1)
