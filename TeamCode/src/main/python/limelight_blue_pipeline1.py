...
# Constants for blue detection - based on FTC-12527-FatDragon implementation
...
def runPipeline(frame, llrobot):
    """
    Main pipeline function for blue sample detection
    ...
    try:
        ...
        # Process blue color using FatDragon method
        blue_contours, blue_hierarchy, blue_gray = process_color(frame, blue_mask)
        ...
        for i, contour in enumerate(blue_contours):
            ...
            for sep_contour in separate_touching_contours(contour):
                ...
                if area > largest_area:
                    ...
                    llpython = [1, center[0], center[1], angle, 3, quadrant, 100, area]
        ...
        for contour_info in valid_contours:
            ...
            # Draw center point
            cv2.circle(frame, contour_info['center'], 5, (255, 0, 0), -1)
        ...
        print(f"Blue pipeline error: {str(e)}")
